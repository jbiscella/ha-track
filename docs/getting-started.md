...
All eight modules share a single version (`0.49.0-alpha`), managed centrally
in the root POM.
...
|---|---|---|
| `commons` | `0.49.0-alpha` | — (JDK only) |
| `indicators` | `0.49.0-alpha` | — (JDK only) |
| `heerwisch-api` | `0.49.0-alpha` | `commons` |
| `heerwisch-jfreechart` | `0.49.0-alpha` | `heerwisch-api`, `indicators`, JFreeChart 1.5 |
| `nachtkrapp` | `0.49.0-alpha` | `commons`, `indicators` |
| `frau-holle` | `0.49.0-alpha` | `commons` |
| `frau-holle-csv` | `0.49.0-alpha` | `frau-holle` |
| `frau-holle-eodhd` | `0.49.0-alpha` | `frau-holle` |
